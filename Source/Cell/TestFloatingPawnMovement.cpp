...
void UTestFloatingPawnMovement::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
	...
	const AController* Controller = dynamic_cast<AController *>(dynamic_cast<APlayerPawn *>(PawnOwner)->Controller);
